...
<script type="text/javascript" src="js/jquery.min.js"></script>
     <script type="text/javascript" src="JSresources/head.js"></script>
     <script src="js/slide/js/slide.min.js"></script>
...
var messageOpts = { 
    ...
    "debug" : false,//是否使用debug模式
      "positionClass" : "toast-top-left",//弹出窗的位置
      "onclick" : null,
...
tishi= function(){
	toastr.error("你尚未登入，请登入!");
}
check=function(){
	toastr.error("你尚未登入，请登入!");
}
check2 =function(){
	toastr.error("对不起你不是管理员，没有权限登入");
}
</script>
</html>
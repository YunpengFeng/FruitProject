...
<head lang="en">
    ...
    <link rel="stylesheet" href="css/register.css">
     ...
     <script type="text/javascript" src="JSresources/bjs/register.js"></script>
...
<div class="inner">
    ...
    <div class="head">
        ...
        <div class="text2">已有账号?<a href="adminmanager"><span>请登入</span></a></div>
    ...
    <div class="c"></div>
        ...
        <div class="meddile">
          ...
          <div class="ll">
              ...
              <div class="cell1"><input class="cell3" type="button"value="立即注册"onclick="adminDoRegister()"/></div>
          </div>
            </form>
